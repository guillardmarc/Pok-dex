<?php
    ...
    if ($_GET) {
        ...
        $req1 = $pdo->prepare("SELECT * FROM immediate_attacks where idImmediateAttacks = $id");
        $req1->execute();
        $ImmediateAttacks = $req1->fetch();

        $link = "immediateattacksUpdate.php?id=$id";
    }

    else {
        $link = "immediateattacksCreate.php";
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section>
            <form action="<?php echo $link; ?>" method="POST">
                <div class="input-group mb-3">
                    ...
                    <input name="nameImmediateAttacks" type="text" class="form-control" placeholder="Nom de l'attaque" value="<?php if ($_GET) {echo $ImmediateAttacks['nameImmediateAttacks'];} ?>">
                </div>
