<?php
    ...
    if ($_GET) {
        ...
        $req1 = $pdo->prepare("SELECT * FROM sex where idsex = $id");
        $req1->execute();
        $Sexs = $req1->fetch();

        $link = "sexsUpdate.php?id=$id";
    }
        ...
        <section>
            <form action="<?php echo $link; ?>" method="POST">
                <div class="input-group mb-3">
                    ...
                    <input name="nameSex" type="text" class="form-control" placeholder="Nom du Sexe" value="<?php if ($_GET) {echo $Sexs['nameSex'];} ?>">
                </div>
