...
if ($_GET) {
    ...
    $req1 = $pdo->prepare("SELECT * FROM types where idType = $id");
    $req1->execute();
    $Types = $req1->fetch();

    $link = "typesUpdate.php?id=$id";
} else {

    $link = "typesCreate.php";
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section>
            <form action="<?php echo $link; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="nameType" type="text" class="form-control" placeholder="Nom du type" value="<?php if ($_GET) { echo  $Types['nameType'];} ?>">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">
                        Photo
                ...
                <input class="btn btn-lg btn-primary mx-auto" type="submit" value="Enregister">
